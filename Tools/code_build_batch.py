...
def batchMain(ccb_files, output_dir, className):
    global customClass;
    global attribute_code;
    global member_variable_code;
    global function_code;
...
path = '../FootBallX/Assets/CCB/FootBallX/Resources/';
ccb_files = ['fb_menu_1', 'fb_menu_2', 'fb_menu_3', 'fb_menu_4', 'fb_menu_5', 'fb_menu_6', 'fb_menu_7', 'fb_menu_8', 'fb_menu_9', 'fb_menu_10']
cf = [];
...
batchMain(cf, "../FootBallX/Classes/", 'CMatchMenuLayer');
